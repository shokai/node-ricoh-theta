  ...
  module.exports = Theta = (function(_super) {
    ...
    Theta.prototype.getProperty = function(code, callback) {
      ...
      return this.client.getDeviceProperty({
        ...
        onFailure: function() {
          return callback('getProperty failed');
        }
      });
    };

    Theta.prototype.getBattery = function(callback) {
      if (callback == null) {
        callback = function() {};
      }
      return this.getProperty(this.client.devicePropCodes.batteryLevel, callback);
    };
