(function() {
  ...
  module.exports = Theta = (function(superClass) {
    extend(Theta, superClass);

    function Theta() {
      var code, fn, isOpen, name, ref;
      this.client = ptp;
      isOpen = false;
    ...
    Theta.prototype.connect = function(host) {
      ...
      this.client.onObjectAdded = (function(_this) {
        return function(res) {
          var object_handle, ref;
          object_handle = (ref = res.parameters) != null ? ref[1] : void 0;
